...
# independant test
test_shot = iter_international_school.Shot(test_id)
...
levels, axes = iter_international_school.flux_map(target[itime])
iter_international_school.flux_map(prediction[itime], axes=axes, levels=levels, colors="C0")
