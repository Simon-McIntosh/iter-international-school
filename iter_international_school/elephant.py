...
# transform real coefficients to complex
...
def hello_elephant(Pn: np.ndarray) -> Generator[PIL.Image.Image, None, None]:
...
def draw_elephant(Pn, step=6) -> Generator[PIL.Image.Image, None, None]:
